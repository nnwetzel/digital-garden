...
export default function Home() {
  ...
  {/* ...removed duplicate 'Recently, I' section... */}
        ...
        <ul className="dash" style={{ textAlign: 'left', display: 'inline-block' }}>
          ...
          <li>Reading <a href="https://www.goodreads.com/book/show/4406.East_of_Eden">East of Eden</a> and <a href="https://www.goodreads.com/book/show/17303566-the-climber-vol-1">The Climber</a></li>
        </ul>
        <div style={{ height: "1.5rem" }} />
